...
<title>DAY2</title>
    ...
    <form action="database.php" method="POST">
     ...
     <b>Username:</b> <input type="text" id="uname" name="uname" required=""><br><br>

     <b>Password</b><input type="password" id="pass" name="pass" required><br><br>

     <b>Confirm Password:</b> <input type="password" placeholder="Confirm Password" id="confirm_pass" required><br><br>

     <b>Name:</b>
     <input type="text" id="name" name="name"><br><br>
     
     <b>Father's Name:</b>
     <input type="text" id="f_name" name="f_name"><br><br><br>
